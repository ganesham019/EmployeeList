...
function validateForm() {
    let namePattern = /^[a-zA-Z0-9_]{5,}[a-zA-Z]+[0-9]*$/;
    let emailPattern = /^[A-Za-z0-9_!#$%&'*+\/=?`{|}~^.-]+@[A-Za-z0-9.-]+$/gm;
    ...
    if (saleryInput.value.length < 3) {
        saleryStatus = false;
        saleryErr.innerText = "Salery is invalid!";
    } else {
        saleryStatus = true;
        saleryErr.innerText = "";
    }
